            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <?php 
                        if(isset($_POST['edit'])) {
                            $id = $_POST['edit-id'];
                            $url = "http://localhost:8888/bainhom/backend/edit-category.php?id=".$id;
                            header("Location: {$url}");
                        }
                    ?>
                            ...
                            <div class="card-body">
                                <?php 
                                    if(isset($_POST['update-category'])) {
                                        ...
                                        $sql = "UPDATE catagories SET category_name = :title, category_status = :status WHERE category_id = :id";
                                        $stmt = $pdo->prepare($sql);
                                        $stmt->execute([
                                            ':title' => $cat_title,
